...
$(document).ready(function() {
	...
	s='<h4>Обозначения:</h4><strong>'+$arBtnTitles[1]+'</strong> - Убийство мафией<br /><strong>'+$arBtnTitles[2]+'</strong>  <br /><strong>'+$arBtnTitles[4]+'</strong> - Проверка Комиссара<br />'+
							$arBtnTitles[5]+'</strong> - Проверка Дона <br /><strong>'+$arBtnTitles[6]+'</strong> <br />'+
							$arBtnTitles[7]+'</strong> - Заголосован днём<br /><strong>'+$arBtnTitles[8]+'</strong> <br />'+
							$arBtnTitles[9]+'</strong> Кокос <br /><br />';
	$('#dInfoSigns').html(s);
	...
	$('#btnReset').click( function(){
		if (!confirm('Все действия будут сброшены. Вы уверены?')) return false;
		$inGame=false;
	...
	if (1==State) { // Сейчас ночь
		...
		$('.tr').each(function(){
			...
			if (0==id) {
				...
				// Если у нас есть в игре ДОН, то делаем кнопку с его действием
				if (0!=$idBeauty) {
